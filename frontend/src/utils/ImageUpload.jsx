...
function ImageUpload() {
  ...
  return (
    <div className="flex flex-col items-center gap-12 ">
      <h1 className="text-5xl font-bold">Maize Disease Prediction</h1>

      <input type="file" accept="image/*" onChange={handleFileChange} />
      {imagePreview && <img src={imagePreview} alt="Preview" style={{ width: "200px", margin: "10px 0" }} />}

      <button onClick={handleSubmit} disabled={loading} className="bg-[#77ab59] text-white text-3xl  p-2 rounded-xl shadow-2xl border-2 border-white border-opacity-35">
